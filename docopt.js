(function() {
  ...
  Pattern = (function() {
    ...
    Pattern.prototype.fix_identities = function(uniq) {
      var c, enumerate, flat, i, k, _i, _j, _len, _len2, _ref, _ref2;
      ...
      for (_j = 0, _len2 = enumerate.length; _j < _len2; _j++) {
        _ref2 = enumerate[_j], i = _ref2[0], c = _ref2[1];
    ...
    Pattern.prototype.fix_list_arguments = function() {
      ...
      var c, child, counts, e, either, _i, _j, _k, _len, _len2, _len3, _ref;
      either = (function() {
      ...
      for (_i = 0, _len = either.length; _i < _len; _i++) {
        ...
        for (_k = 0, _len3 = child.length; _k < _len3; _k++) {
          e = child[_k];
          if (counts[e] > 1 && e.constructor === Argument) e.value = [];
        }
      }
      return this;
    };
    ...
    Pattern.prototype.either = function() {
      var c, children, e, either, group, groups, i, indices, name, oneormore, optional, required, ret, types, zip, _i, _j, _len, _len2, _ref, _ref2, _ref3;
      if (!this.hasOwnProperty('children')) {
        ...
        return new Either((function() {
          ...
          _results = [];
          for (_k = 0, _len3 = ret.length; _k < _len3; _k++) {
            e = ret[_k];
    ...
    Argument.prototype.match = function(left, collected) {
      ...
      args = (function() {
        ...
        for (_i = 0, _len = left.length; _i < _len; _i++) {
          l = left[_i];
          if (l.constructor === Argument) _results.push(l);
        }
        return _results;
      })();
  ...
  Option = (function(_super) {
    ...
    Option.parse = function(description) {
      var argcount, long, matched, options, s, short, value, _, _i, _len, _ref, _ref2, _ref3, _ref4;
      description = description.replace(/^\s*|\s*$/g, '');
      _ref2 = (_ref = description.match(/(.*?)  (.*)/)) != null ? _ref : [null, description, ''], _ = _ref2[0], options = _ref2[1], description = _ref2[2];
      options = options.replace(/,|=/g, ' ');
      _ref3 = [null, null, 0, false], short = _ref3[0], long = _ref3[1], argcount = _ref3[2], value = _ref3[3];
      _ref4 = options.split(/\s+/);
  ...
  AnyOptions = (function(_super) {
    ...
    function AnyOptions() {
      AnyOptions.__super__.constructor.apply(this, arguments);
    }
    ...
    AnyOptions.prototype.match = function(left, collected) {
      ...
      left_ = (function() {
        ...
        for (_i = 0, _len = left.length; _i < _len; _i++) {
          l = left[_i];
          if (l.constructor !== Option) _results.push(l);
        }
        return _results;
      })();
      return [left.join(', ') !== left_.join(', '), left_, collected];
  ...
  Required = (function(_super) {
    ...
    function Required() {
      Required.__super__.constructor.apply(this, arguments);
    }

    Required.prototype.match = function(left, collected) {
      var c, l, matched, p, _i, _len, _ref, _ref2;
      if (collected == null) collected = [];
      l = left;
      c = collected;
      _ref = this.children;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        p = _ref[_i];
        _ref2 = p.match(l, c), matched = _ref2[0], l = _ref2[1], c = _ref2[2];
  ...
  Optional = (function(_super) {
    ...
    function Optional() {
      Optional.__super__.constructor.apply(this, arguments);
    }

    Optional.prototype.match = function(left, collected) {
      var m, p, _i, _len, _ref, _ref2;
      if (collected == null) collected = [];
      _ref = this.children;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        p = _ref[_i];
        _ref2 = p.match(left, collected), m = _ref2[0], left = _ref2[1], collected = _ref2[2];
      }
      return [true, left, collected];
    };
  ...
  OneOrMore = (function(_super) {
    ...
    function OneOrMore() {
      OneOrMore.__super__.constructor.apply(this, arguments);
    }
  ...
  Either = (function(_super) {
    ...
    function Either() {
      Either.__super__.constructor.apply(this, arguments);
    }
    ...
    while (raw.length > 0) {
      opt = (function() {
        ...
        for (_i = 0, _len = options.length; _i < _len; _i++) {
          o = options[_i];
          if (o.short !== null && o.short[1] === raw[0]) _results.push(o);
        }
        return _results;
      })();
      if (opt.length > 1) {
  ...
  parse_long = function(tokens, options) {
    var o, opt, raw, value, _, _ref, _ref2;
    _ref2 = (_ref = tokens.current().match(/(.*?)=(.*)/)) != null ? _ref : [null, tokens.current(), ''], _ = _ref2[0], raw = _ref2[1], value = _ref2[2];
    tokens.shift();
    ...
    opt = (function() {
      ...
      for (_i = 0, _len = options.length; _i < _len; _i++) {
        o = options[_i];
        if (o.long && o.long.slice(0, raw.length) === raw) _results.push(o);
      }
      return _results;
    })();
    if (opt.length > 1) {
  ...
  parse_atom = function(tokens, options) {
    ...
    if (token === '(') {
      ...
      if (tokens.shift() !== ')') raise(tokens.error("Unmatched '('"));
      return result;
    } else if (token === '[') {
      tokens.shift();
  ...
  extras = function(help, version, options, doc) {
    ...
    for (_i = 0, _len = options.length; _i < _len; _i++) {
      opt = options[_i];
      if (opt.value) opts[opt.name()] = true;
    }
  ...
  Dict = (function(_super) {
    ...
    Dict.prototype.toString = function() {
      ...
      atts = (function() {
        ...
        _results = [];
        for (k in this) {
          if (k !== 'constructor' && k !== 'toString') _results.push(k);
        }
        return _results;
      }).call(this);
      atts.sort();
    ...
    if (matched && left.length === 0) {
      options = (function() {
        ...
        for (_i = 0, _len = argv.length; _i < _len; _i++) {
          opt = argv[_i];
          if (opt.constructor === Option) _results.push(opt);
        }
        return _results;
      })();
      pot_arguments = (function() {
        var _i, _len, _ref2, _ref3, _results;
        _ref2 = formal_pattern.flat();
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          a = _ref2[_i];
          if ((_ref3 = a.constructor) === Argument || _ref3 === Command) {
            _results.push(a);
          }
        }
        return _results;
